            ...
            <td style="background-color:#2C2C2C">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="6">
                    ...
                    <tr>
                        ...
                        <td width="30%" height="50" align="left" style="font-size:14px;color:#FFF">用户名为email</td>
                    </tr>
                    <tr>
                        <td height="50" align="right" style="font-size:14px;color:#FFF">旧密码：</td>
                        <td><input type="password" id="old_password" placeholder="旧密码" style="WIDTH: 150px; HEIGHT: 25px"></td>
                        <td height="50" align="left" style="font-size:14px;color:#FFF">密码不能为空</td>
                    </tr>
                    <tr>
                        <td height="50" align="right" style="font-size:14px;color:#FFF">新密码：</td>
                        <td><input type="password" id="new_password"  placeholder="新密码" style="WIDTH: 150px; HEIGHT: 25px"></td>
                        <td height="50" align="left" style="font-size:14px;color:#FFF">密码不能为空</td>
                    </tr>
                    <tr>
                        <td height="50" align="right" style="font-size:14px;color:#FFF">再输一次新密码：</td>
                        <td><input type="password" id="new_password_again"  placeholder="再输一次新密码" style="WIDTH: 150px; HEIGHT: 25px"></td>
                        <td height="50" align="left" style="font-size:14px;color:#FFF">与前一次输入一致</td>
                    </tr>
                    <tr>
                        <td height="40" colspan="3" align="center" style="padding-top:10px;">
                            <button class="btn" id="modify" style="width:100px">修改</button>
                        </td>
                    </tr>
...
<script type="text/javascript">
    $("#modify").click(function(){
        ...
        if(username=='' || password=='' || new_password=='' || new_password_again == '') {
            alert("请输入用户名或密码");
            return false;
        }
        ...
        $.ajax({
            url: 'user.do?username='+username+'&passwd='+password+'&newPasswd='+new_password+'&action=UP',
            dataType: "text",
