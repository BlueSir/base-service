...
import com.nsq.oss.json.simple.JSONAware;
import com.nsq.oss.json.simple.JSONFormatter;
import com.nsq.oss.json.simple.JSONObject;
import com.nsq.oss.json.simple.JSONValue;
...
//					log.info("key : " + key + " " + this.getString(key) + " VS " + other.getString(key));
    ...
    private String toXMLStringCollection(Collection c) {
        if (c == null)
            return "";
        ...
        for (Object o : c) {
            ...
            if (o instanceof DynMap)
                ...
                for (Object b : (Collection) o) {
                    collection += "<item>";
                    if (b instanceof Collection)
                        collection += this
                                .toXMLStringCollection((Collection) b);
                    else
    ...
    public String toXMLString() {
        ...
        while (iter.hasNext()) {
            ...
            if (entry.getValue() instanceof DynMap) {
                ...
                buf.append(this
                        .toXMLStringCollection((Collection) entry
                                .getValue()));
