...
import static com.sohu.smc.base.server.Config.requestBufferSize;
import static com.sohu.smc.base.server.Config.requestHeaderBufferSize;
...
public abstract class AbstractServer {
    ...
    private static final String CLASS_ONLY_AVAILABLE_IN_IDE = "com.sohu.smc.base.server";
    ...
    private SelectChannelConnector createConnector() {
        ...
        connector.setRequestHeaderSize((int) requestHeaderBufferSize.toBytes());
